...
<head>
    ...
    <style>
        * {
        ...
        /* Full-screen fixed Spline Background */
        .background {
            position: fixed;
            top: 0;
            left: 0;
...
<body>
    ...
    <!-- Full-Screen Fixed Spline Background -->
    <iframe class="background" src="https://my.spline.design/hypnotism-ffd40072e3487093b920613c8b5acf7d/"></iframe>

    <div class="container">
        <h2>Stuttering Analysis Report for ${result.filename}</h2>
        <table>
            <tr><th>Detected Stuttering Types</th><td>${result.detected_stuttering_types.join(", ")}</td></tr>
            <tr><th>Speech Therapy Suggestions</th><td>${result.therapy_suggestions}</td></tr>
